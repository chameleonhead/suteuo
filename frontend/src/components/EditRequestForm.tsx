...
export const EditRequestForm = (props: EditRequestFormProps) => {
    ...
    const formik = useFormik({
        ...
        validate: value => {
            ...
            if (!value.detailedText) {
                errors.detailedText = '必須項目です。'
            }
            return errors
        },
        onSubmit: onSubmit,
        ...
        <Form onSubmit={formik.handleSubmit}>
            ...
            <FormGroup>
                ...
                <Input
                    ...
                    type="textarea"
                    onChange={formik.handleChange}
                    value={formik.values.detailedText}
                    invalid={formik.touched.detailedText && formik.errors.detailedText ? true : false}
                />
